        ...
        <div className="bg-gradient-to-r from-[#38AD81] to-[#2d8f6a] px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-green-100 text-sm mt-1">Add a new category to your collection</p>
            </div>
            <Button 
              variant="ghost" 
              size="icon" 
            ...
            <div className="space-y-3">
              ...
              {formData.subcategories.length > 0 && (
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-gray-600">Current Subcategories</span>
                  </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-gray-600">Add New Subcategory</span>
                </div>
